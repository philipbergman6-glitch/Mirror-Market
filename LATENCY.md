...
| Stage | Time | Source |
|---|---|---|
| Full daily pipeline, all 29 layers | **6 m 02 s** | production CI 2026-08-18, first to last freshness stamp (13:53:22 → 13:59:24) in `data/history/data_freshness.csv` |
...
`forward_curve`) over `FAST_REFRESH_HISTORY_PERIOD` (`1mo`) instead of all 29
layers over `15y`.
