...
- `pipeline/schema.py` — All 25 `CREATE TABLE IF NOT EXISTS` SQL definitions. No functions — just the table blueprints used by `store.py`.
...
22. Emerging Markets (South Africa SAFEX price + SAGIS delivery pace + Brazil CEPEA/CONAB farmgate + India mandi bean vs CBOT + Nigeria deep dive)
